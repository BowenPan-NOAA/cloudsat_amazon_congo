...
# PURPOSE:
#   Update the readin method to xarray (Hope to speed up the code)
#   Match Juliet's dataset with CLDCLASS
#   Split the objects into many cloud objects
#   Save to a monthly output csv
#   only save the surface flag
#   Add environmental parameter to csv
#   Add ECMWF-AUX environmental variables to csv
# OUTPUT:
#    txt file with 
#    JulietDate，Granule，SN，Pedestal/Anvil width， cutoff height
#    env file with
#    JulietDate，Granule，SN，COmeanLon,COmeanLat,mCAPE,mCIN,mLCL,mSOIL,
#    mSFLX,mLFLX,mMSLP,mSST, momega, mlowVWS, mmidVWS, mupVWS, mttlVWS,
#    mdirlowVWS, mdirmidVWS, mdirupVWS, mdirttlVWS,
#    mlowSH, mmidSH, mupSH, mttlSH, COmeanAOD, COmeanRAIN,COmeanCTT,COminCTT,COmeanIWP,COmeanSWP)
# UPDATEs:
#   Feb. 10, 2023: update to xarray readin and update 2007- ERA5 readin; 2006 ERA5 readin is different
#   Jan. 30, 2023: add IWV and saturation IWV as saved variables, also add vertical profile of T, Td, U, V
#   Nov. 8, 2022: update to xarray readin method 
#   Nov. 3, 2022: fixed the bug with SST, LCL, CIN, SOIL readin (the masked area given unreasonable values)
#   Sep 23, 2022: update the readin for ERA5, due to the change of data formate from single layer 2007 Jan. onset
#   Aug 31, 2022: update the pedestal definition with tropopause and topography
#   May 31, 2022: eliminate the convection fraction threshold
#   May 26, 2022: eliminate short CloudSat-only region (fdx-idx=1); change the cldlon (-179,179) to 360 to match CLDCLASS lon
#   May 25, 2022: add soil moisture saturation fraction, adjust ECMWF-AUX calculation method 
#   May 19, 2022: change ERA5 environment (VWS) to ECMWF-AUX
#   Apr 27, 2022: add surface txt to the csv files output
#   Apr 24, 2022: update the file to add environmental txt
#   Apr 6，2022： created the file 
#   Jan 26, 2022: add deep convective core dimension to the variables 
#                 potentially add vapor MR, surface moisture, LWP, VWS direction
#   Apr. 5, 2023: use Juliet's update dataset, 
